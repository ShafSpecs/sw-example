...
import { matchAssetRequest, matchLoaderRequest } from "sw2";
import { matchDocumentRequest } from "sw2";
import { remixLoaderPlugin } from "./remix-pwa-sw/workbox/plugin";
...
const messageHandler = new RemixMessageHandler()
